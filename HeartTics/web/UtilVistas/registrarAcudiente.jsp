<%-- 
    ...
    Created on : 17/10/2016, 06:30:17 PM
    Author     : Andrea
--%>
...
<%
    ...
    long estudiante = Long.parseLong(request.getParameter("estudiante"));
    ...
    try {
        ...
        boolean es = controlador.registrarAcudiente(Integer.parseInt(tipoDoc), numDoc, correo, fecha,
                ...
                paisNacimiento, paisActual, usuario, contra, estudiante, profesion);
        if (!es) {
%>
<script text="javascript">
    alert("Registro exitoso");
    window.location.href = "../Vistas/registrarAcudiente.jsp"
</script>
<%
} else {%>
<script text="javascript">
