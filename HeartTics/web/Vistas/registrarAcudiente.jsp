<%-- 
    Document   : registrarAcudiente
    Created on : 15/10/2016, 08:45:06 PM
    Author     : Andrea
--%>
...
<html>
    ...
    <body>
        ...
        %>
        <div class="row">
            <div class="col-md-6 col-md-offset-4"><h1>Registrar Acudientes</h1></div>
        </div>


        <form id="frmRegistrarEstudiante" action="../UtilVistas/registrarAcudiente.jsp">
            ...
            <div class="row">
                ...
                <div class="col-xs-6 col-sm-4">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="profesion" value="" class="form-control" placeholder="Profesión del acudiente" />
                    </div>
                    <div class="form-group">
                        <label>Usuario</label>
